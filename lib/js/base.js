...
Object.prototyp.clone=function(){
    var newObj;
    if(this.constructor==Object) newObj=new this.constructor();
    else  newObj=new this.constructor(this.valueOf());
    for(var key in this){
...
function fixEvt(evt,o) {
    ...
    //evt.pageX,evt.clientX火狐谷歌欧鹏均有，ie9没有，只有evt.clientX;
    //evt.layerX,evt.offsetX火狐谷歌欧鹏均有,谷歌中layerX=offsetX，ie仅有offsetX;  evt.layerX=evt.offsetX+o.clientLeft;
